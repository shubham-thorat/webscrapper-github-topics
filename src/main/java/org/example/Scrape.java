...
public class Scrape {
    ...
    // tasks get repo page - convert into tablesaw return tables and create csv
    // files
    public Table scrape_topics_repo(String topic_url, String topic_name) throws Exception {
        ...
        StringColumn c3 = StringColumn.create("Repo Names", repo_names);
        StringColumn c4 = StringColumn.create("Stars", repo_stars);
        StringColumn c5 = StringColumn.create("Repo URL", repo_urls);

        repos.addColumns(c1, c2, c3, c4, c5);
        return repos;
    }
...
/*
 * Single function i) get a list of topics from topics page ii) get list top
 * repos for topics ii) create csv for each topic
 */